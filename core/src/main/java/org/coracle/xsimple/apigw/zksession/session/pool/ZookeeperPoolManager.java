 ...
 */
package org.coracle.xsimple.apigw.zksession.session.pool;
...
public class ZookeeperPoolManager {
    ...
    private PoolableObjectFactory<ZooKeeper> factory;
    ...
    public void init(Configuration config) {
        factory = new ZookeeperPoolableObjectFactory(config);
